...
public class CommonConfiguration implements ICommonConfig
{
    ...
    public JsonObject serialize()
    {
        ...
        entry6.addProperty("desc:",
            "Sets the amount of protection level a protection enchantment does give, per enchantment level. By default these are vanilla levels, you can add modded protection enchant ids aswell.");
